...
<a href="#" class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-10 h-10 p-2 rounded-full" style="background-color: #DEEDFB; color: #0a0a0aff;">
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
    ...
    <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      ...
      <button class="text-white bg-blue-300 border-0 py-2 px-8 focus:outline-none hover:bg-blue-200 rounded text-lg">Button</button>
...
<a href="#" class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-10 h-10 p-2 rounded-full" style="background-color: #DEEDFB; color: #080808ff;">
    <path d="M5 16c-1.1 0-1.99.9-1.99 2S3.9 20 5 20s2-.9 2-2-.9-2-2-2zM19 16c-1.1 0-1.99.9-1.99 2S17.9 20 19 20s2-.9 2-2-.9-2-2-2zM5.85 12h12.3c.69 0 1.2-.72.95-1.36L17.4 6.2c-.18-.38-.58-.62-1-.62H7.6c-.42 0-.81.24-1 .62L4.9 10.64c-.25.64.26 1.36.95 1.36zM18 10H6l-1.5 4.5h13L18 10z"/>
</svg>
                <span class="ml-3 text-xl">Ecoride</span>
            </a>
